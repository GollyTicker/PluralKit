...
check "$(curl -s http://localhost:5001/v2/systems/aaaaaa 2>&1)" == "Some(System(1)) None"

check "$(curl -s http://localhost:5001/v2/systems/$UUID1 2>&1)" == 'Some(System(1)) None'

check "$(curl -s http://localhost:5001/v2/systems/502894289114628110 2>&1)" == 'Some(System(1)) None'



check "$(curl -s http://localhost:5001/v2/members/aaa10 2>&1)" == "Some(Member { id: 10, system: 1 }) None"

check "$(curl -s http://localhost:5001/v2/members/aaa11 2>&1)" == 'Some(Member { id: 11, system: 1 }) None'

check "$(curl -s http://localhost:5001/v2/members/$MEM10 2>&1)" == "Some(Member { id: 10, system: 1 }) None"

check "$(curl -s http://localhost:5001/v2/members/$MEM11 2>&1)" == 'Some(Member { id: 11, system: 1 }) None'



check "$(curl -s http://localhost:5001/v2/groups/grp11 2>&1)" == "Some(Group { id: $GRP11_ID, system: 1 }) None"

check "$(curl -s http://localhost:5001/v2/groups/$GRP11 2>&1)" == "Some(Group { id: $GRP11_ID, system: 1 }) None"

check "$(curl -s http://localhost:5001/v2/groups/grp12 2>&1)" == "Some(Group { id: $GRP12_ID, system: 1 }) None"

check "$(curl -s http://localhost:5001/v2/groups/$GRP12 2>&1)" == "Some(Group { id: $GRP12_ID, system: 1 }) None"



check "$(curl -s http://localhost:5001/v2/systems/bbbbbb 2>&1)" == "Some(System(2)) None"

check "$(curl -s http://localhost:5001/v2/systems/$UUID2 2>&1)" == 'Some(System(2)) None'

check "$(curl -s http://localhost:5001/v2/systems/502894289114628111 2>&1)" == 'Some(System(2)) None'



check "$(curl -s http://localhost:5001/v2/systems/aaaaaa/switches/$SW1000 2>&1)" == "Some(Switch { id: 1000, system: 1 }) None"

check "$(curl -s http://localhost:5001/v2/systems/aaaaaa/switches/$SW1001 2>&1)" == 'Some(Switch { id: 1001, system: 1 }) None'

check "$(curl -s http://localhost:5001/v2/systems/bbbbbb/switches/$SW2000 2>&1)" == "Some(Switch { id: 2000, system: 2 }) None"



check "$(curl -s http://localhost:5001/v2/groups/grp21 2>&1)" == "Some(Group { id: $GRP21_ID, system: 2 }) None"

check "$(curl -s http://localhost:5001/v2/groups/$GRP21 2>&1)" == "Some(Group { id: $GRP21_ID, system: 2 }) None"

check "$(curl -s http://localhost:5001/v2/groups/grp22 2>&1)" == "Some(Group { id: $GRP22_ID, system: 2 }) None"

check "$(curl -s http://localhost:5001/v2/groups/$GRP22 2>&1)" == "Some(Group { id: $GRP22_ID, system: 2 }) None"



check "$(curl -s -H 'Authorization: pk_test_dev_token' http://localhost:5001/v2/systems/@me 2>&1)" == 'Some(System(1)) Some(1)'

check "$(curl -s -H 'Authorization: pk_test_dev_token_2' http://localhost:5001/v2/systems/@me 2>&1)" == 'Some(System(2)) Some(2)'
...
check "$(curl -s -H 'Authorization: pk_test_dev_token' http://localhost:5001/v2/systems/bbbbbb 2>&1)" == 'Some(System(2)) Some(1)'

check "$(curl -s -H 'Authorization: pk_test_dev_token_2' http://localhost:5001/v2/members/aaa10 2>&1)" == 'Some(Member { id: 10, system: 1 }) Some(2)'
